...
export function Preview({ planetData, selectedColor, selectedSegmentum }: PreviewProps) {
   ...
   return (
      <div className="space-y-2">
         ...
         <div className="w-96 bg-black/95 border border-amber-500/30 rounded-lg max-h-[53vh] overflow-y-auto overflow-x-hidden">
            {/* Header com banner */}
            ...
            <div className="p-6 space-y-4">
               <div className="space-y-4">
                  ...
                  <div className="flex justify-between gap-4">
                     ...
                     <div className="border border-amber-500/30 rounded-md p-4 px-6 space-y-1 w-full">
                        ...
                        <p className={`font-bold ${planetData.status === "destruido" ? "text-red-500" : "text-green-500"
                           }`}>
               ...
               <div className="border border-amber-500/30 rounded-md p-4 px-6 space-y-1 w-full">
                  ...
                  <p className="text-slate-100">
                     {planetData.description || "Nenhum relatório disponível ou atribuído"}
                  </p>
               </div>
                  ...
                  <div className="border border-amber-500/30 rounded-md p-4 px-6 space-y-1 w-full">
                     ...
                     <div className="flex items-center gap-2">
                        <div
                           ...
                           style={{
                              backgroundColor: selectedColor === "Azul" ? "#0080ff" :
                                 selectedColor === "Verde" ? "#00ff80" :
                                    selectedColor === "Vermelho" ? "#ff0000" :
                                       selectedColor === "Amarelo" ? "#ffcc00" :
                                          selectedColor === "Roxo" ? "#cc00ff" : "#ffffff"
                           }}
                        />
