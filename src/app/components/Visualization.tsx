      ...
      <>
         {!isOpen && (
            <Button
               ...
               className="fixed bottom-18 right-3.5 z-20 p-2 transition-all duration-300"
            >
               <Eye className="!w-6 !h-6" />
            </Button>
         )}
         <div
            className={`fixed bottom-18 right-3.5 z-50 bg-black/90 border border-amber-500/30 rounded-lg text-white pointer-events-auto transform transition-all duration-500 ease-out ${isOpen
